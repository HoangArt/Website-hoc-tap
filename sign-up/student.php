...
<head>
    ...
    <title>Tạo tài khoản mới cho Học sinh và Người học | Ong Nhỏ</title>
</head>
                        ...
                        <div class="row g-0">
                            <div class="col-12 col-md-6 ">
                                <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy"
                                    id="roleImage" src="../img/login/student.png" alt="Đăng ký tài khoản">
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-5">
                                                    ...
                                                    <h4 class="text-center">Tạo tài khoản mới cho học sinh</h4>
                                                </div>
                                            </div>
                                        </div>
