...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($date_of_birth == $_SESSION['date_of_birth']) {
        // Kiểm tra nếu không thay đổi
        $error = "Vui lòng thay đổi Ngày sinh của bạn.";
    } else {
        if (empty($user_id)) {
            ...
            if ($stmt === false) {
                ...
                $stmt->bind_param("ss", $date_of_birth, $user_id); // Liên kết tham số với câu lệnh SQL
...
<head>
    ...
    <title>Thay đổi Ngày sinh | Ong Nhỏ</title>
...
<body>
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                <div class="container">
                    <h2 class="mb-4">Thay đổi Ngày sinh</h2>
                    ...
                    <form method="post" action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                        <div class="mb-3">
                            ...
                            <input type="date" name="date_of_birth" class="form-control <?= !empty($error) ? 'is-invalid' : ''; ?>"
